			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul class="font-11 list-relative list-li-pl-30 list-block list-li-mb-15">
						<li><i class="abs-tl ion-ios-location"></i>Jl. Veteran <br/>83660. Indonesia</li>
						<li><i class="abs-tl ion-android-mail"></i>ican.notfound@gmail.com</li>
						<li><i class="abs-tl ion-android-call"></i>0852-3725-7394</li>
					</ul>
