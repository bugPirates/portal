        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>Portal Desa</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-inner">
                ...
                <div class="page-footer">
                    <p class="no-s"><?php echo date('Y');?> &copy; Edited by Pemerintah Desa, Kawil Gubuk. DayaTimuq</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
